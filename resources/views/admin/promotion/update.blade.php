            ...
            <div class="offset-md-3 col-md-6">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Cập nhật khuyến mãi - {{ $pm->promotion_name }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    @if($errors->any())
                    ...
                    <form role="form" action="{{ Route('promotion.postUpdate',$pm->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" value="1" name="option" id="product_type_id_option" onclick="option2()" checked>Product Type ID
                                <!-- </select> -->
                            </div>
                            @elseif($pm->product_id == 1)
                            <div class="form-group">
                                <label for="txt-type">Giảm giá theo: </label>
                                <!-- <select class="form- control" id="txt-type" name="promotion_with"> -->
                                <!-- onclick -->
                                <input type="radio" value="0" name="option" id="product_id_option" onclick="option1()" checked>Product ID
                            ...
                            <div class="form-group" id="promotion-type-id" style="display: none;">
                                ...
                                <input type="text" class="form- control" id="txt-promotion-type-id" name="product_type_id" value='{{ $pm->promotion_type_id }}' placeholder="Enter Name here...">
                            </div>

                            <!-- Product ID -->
                            <div class="form-group" id="promotion-id" style="display: none;">
                                <label for="txt-promotion-id">Sản phẩm</label>
                                <input type="text" class="form- control" id="txt-promotion-id" name="product_id" value='{{ $pm->promotion_id }}' placeholder="Enter Name here...">
                            </div>
                            <!-- Brand ID -->
                            <div class="form-group">
